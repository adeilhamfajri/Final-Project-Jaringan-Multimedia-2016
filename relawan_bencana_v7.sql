...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 20, 2016 at 03:03 AM
...
CREATE TABLE `gambar` (
  ...
  `esktensi_gambar` varchar(50) NOT NULL,
...
INSERT INTO `gambar` (`id_gambar`, `nama_gambar`, `esktensi_gambar`, `deskripsi_gambar`, `tanggal_gambar`) VALUES
(1, '', '', 'osas', '2016-12-20');
...
INSERT INTO `kebutuhan` (`id_kebutuhan`, `id_lokasi`, `id_barang`, `jumlah_kebutuhan`, `jumlah terpenuhi`, `status`, `tanggal_permintaan`) VALUES
