                ...
                <div class="page-content">
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-violet">
                            <div class="panel-heading" align="center">Edit Gambar Realtime Bencana</div>
                            <div class="panel-body">
                            <form method="POST" action="<?php echo base_url().'index.php/crud_gambar/do_updateImage' ?>" enctype="multipart/form-data">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td><img height="100" width="250" src="<?php echo base_url(); ?>/assets/img/bencana/<?php echo $nama_gambar; ?>" /></td>
                                        <td><input name="fileToUpload" style="width: 100%; padding: 0px; margin: 0px;" type="file"></td>
                                        <input type="hidden" name="nama_gambar" value="<?php echo $nama_gambar; ?>" />
                                        <td><input type="text" name="deskripsi_gambar" value="<?php echo $deskripsi_gambar; ?>" /></td>
                                         <td><input type="text" name="tanggal_gambar" value="<?php echo $tanggal_gambar; ?>" /></td>
                                        <td><input data-loading-text="Loading..." style="width: 100%; padding: 0px; margin: 0px;" type="submit" name="submit" class="btn btn-primary" value="Simpan"></td>   
                                    </tr>
